...
figure(image("img/honeycomb_code_def.png",width:70%)))
 
#pagebreak()
=== Measurement Visualized

#figure(image("img/honeycomb_code_meas.png",width:20%))
...
figure(image("img/honeycomb_superlattice.png",width:70%))) @Hastings2021
